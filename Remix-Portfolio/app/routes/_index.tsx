    ...
    return(
        <div className="mx-auto w-full bg-purple-950 overflow-x-clip text-slate-100 text-lg">
                ...
                <div className='absolute top-28 md:w-[50%] md:text-xl font-sans flex-wrap px-[5%] '>
                   <div className='relative'>
                    ...
                    <div className='relative grid grid-cols-2 w-[90%] top-[6vh]'>
                        ...
                        <div className='z-10 relative pl-5'>
                            ...
                            <a href='#' className='flex pt-5 text-sm md:text-lg'>View
                                <span className='relative pl-6 bottom-2 flex-grow'>
            ...
            <section className='relative w-full'>
                    ...
                    <div>
                        ...
                        <div className='absolute'>
                            <div className='pl-[8%]'>
                                ...
                                <a><button className='relative top-7 rounded-full py-3 px-10 border-solid border-2 hover:bg-yellow-300 hover:text-black'>View Site</button></a>
                            </div>
                ...
                <div className='relative pt-[122rem] lg:pt-[130rem]'>
